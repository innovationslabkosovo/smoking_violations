...
?>
		...
		<div class="rb_list-and-map-box">
			...
			foreach ($locations as $location) {
				...
				$incident_verified = $location->location_image;
				...
				foreach ($incidents as $incident)
				{
					...
					if ($location_id1 ==$location_id )
					{
						...
						$incident_thumb = url::file_loc('img')."media/img/". $location_id1.".jpg";
			...
			<?php
				...
				?>
					...
					<div id="<?php echo $location_id1 ?>"><?php  // if ($rat_count > 5) { $incident_verified = true ;}?>
						<div class="r_media">
							<p class="r_photo" style="text-align:center;"> <a href="<?php echo url::site(); ?>reports?l=<?php echo $location_id1; ?>">
								<img src="<?php echo $loc_thumb; ?>"  /> </a>
							</p>
						...
						<div class="r_details">
							...
							?>
							<a  class="r_title" href="<?php echo url::site(); ?>reports?l=<?php echo $location_id1; ?>">
								<h3><?php echo  $location_name1 ?></h3>
								<span>(<?php echo $counter?> Reports)</span>
							</a>
							<a style ='display:none' href="<?php echo url::site(); ?>reports/view/<?php echo $incident_id; ?>#discussion" class="r_comments"></a> 			
							
							<span class="latest_violation"><strong>Last Violation: </strong><?php echo $last_date; ?></span>
							...
							<!--<p ><?php echo "Violation ".Kohana::lang('ui_main.categories'); ?></p> -->
								...
								foreach ($cats as $category): ?>
									...
									<?php if ($category->category_image_thumb): ?>
										<?php $category_image = url::base().Kohana::config('upload.relative_directory')."/".$category->category_image_thumb; ?>
										<a class="r_category" href="<?php echo url::site(); ?>reports/?c=<?php echo $category->id; ?>">
											<span style=""><?php echo $ct[$i]." ".$category->category_title; ?></span>
											<span class="r_cat-box"><img src="<?php echo $category_image; ?>" height="16" width="16" /></span> 
											<span class="r_cat-desc"><?php  echo($ct[$i])." ";echo $category->category_title;?></span>
										</a>
									<?php else:?>
										<a class="r_category" href="<?php echo url::site(); ?>reports/?c=<?php echo $category->id; ?>">
											<span style=""><?php echo $ct[$i]." ".$category->category_title; ?></span>
